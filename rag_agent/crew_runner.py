...
Design:
  - Wraps rag_agent/graph.py's run_pipeline() — zero new logic implemented here.
...
Usage:
    python rag_agent/crew_runner.py
    LANGCHAIN_TRACING_V2=true LANGCHAIN_API_KEY=ls__... python rag_agent/crew_runner.py
"""
